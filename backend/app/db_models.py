...
class InterviewQuestion(Base):
    ...
    evaluation_feedback: Mapped[str] = mapped_column(Text, default="")
    ...
    coaching_feedback: Mapped[str] = mapped_column(Text, default="")
    predicted_follow_ups: Mapped[str] = mapped_column(Text, default="[]")
